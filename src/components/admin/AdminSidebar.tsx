...
import { Building2, Ticket, Sparkles, CreditCard, Zap, Eye, Inbox, LayoutDashboard, Settings, LogOut } from "lucide-react";
...
interface AdminSidebarProps {
  ...
  /** Server-computed flag (K3). Billing renders only when set. Users/Roles moved
   *  into the /hq/settings hub (J4), so they no longer gate sidebar items. */
...
export default function AdminSidebar({ systemRole, canManageBilling }: AdminSidebarProps) {
